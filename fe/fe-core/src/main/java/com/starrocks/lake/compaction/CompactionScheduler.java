...
public class CompactionScheduler extends Daemon {
    ...
    private static final long LOOP_INTERVAL_MS = Config.lake_compaction_schedule_interval_ms;
    ...
    private void scheduleNewCompaction() {
        ...
        List<PartitionStatisticsSnapshot> partitions =
                compactionManager.choosePartitionsToCompact(runningCompactions.keySet(), disabledTables);
