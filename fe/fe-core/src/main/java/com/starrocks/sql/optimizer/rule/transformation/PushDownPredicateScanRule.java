...
public class PushDownPredicateScanRule extends TransformationRule {
    ...
    public static final PushDownPredicateScanRule FLUSS_SCAN =
            new PushDownPredicateScanRule(OperatorType.LOGICAL_FLUSS_SCAN);
    public static final PushDownPredicateScanRule ODPS_SCAN =
            new PushDownPredicateScanRule(OperatorType.LOGICAL_ODPS_SCAN);
