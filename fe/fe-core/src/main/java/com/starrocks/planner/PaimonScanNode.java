...
public class PaimonScanNode extends ScanNode {
    ...
    private void traceReaderMetrics(String predicateHash) {
        ...
        String prefix = "Paimon.scan.reader." + paimonTable.getTableName() + "-" + predicateHash + ".";
        ...
        String dvPrefix = "Paimon.scan.deletionVector." + paimonTable.getTableName() + "-" + predicateHash + ".";
