...
public class PaimonPredicateConverterTest {
    ...
    public void testPaimonCastPredicate() {
        ...
        long expectedMillis = LocalDate.parse("2025-01-01").atTime(0, 0, 0, 0)
                ...
                .toInstant()
                .toEpochMilli();
        Assert.assertEquals(expectedMillis, ((Timestamp) (leafPredicate8.literals().get(0))).getMillisecond());
        ...
        expectedMillis = LocalDate.parse("2025-01-01").atTime(0, 0, 0, 0)
                ...
                .toInstant()
                .toEpochMilli();
        Assert.assertEquals(expectedMillis, ((Timestamp) leafPredicate.literals().get(0)).getMillisecond());
