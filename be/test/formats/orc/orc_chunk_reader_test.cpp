...
/*
  tpch_10k.orc.zstd, generated by pyorc with the following parameters for the writer:
  ...
  Stripe 1:
    ...
    Column 1: count: 5120 hasNull: false min: 1 max: 62 sum: 152799
    Column 2: count: 5120 hasNull: false min: 19920103 max: 19950429 sum: 102052621474
    Column 3: count: 5120 hasNull: false min: 6980 max: 5999748 sum: 15379646994
    Column 4: count: 5120 hasNull: false min: 1-URGENT max: 5-LOW sum: 39399
    Column 5: count: 5120 hasNull: false min: 0 max: 127 sum: 321638
    Column 6: count: 5120 hasNull: false min: 1 max: 2000 sum: 5149884
  Stripe 2:
    Column 0: count: 4880 hasNull: false
    Column 1: count: 4880 hasNull: false min: 1 max: 62 sum: 136124
    Column 2: count: 4880 hasNull: false min: 19950429 max: 19980802 sum: 97429087412
    Column 3: count: 4880 hasNull: false min: 320 max: 5995360 sum: 14275214055
    Column 4: count: 4880 hasNull: false min: 1-URGENT max: 5-LOW sum: 37392
    Column 5: count: 4880 hasNull: false min: 0 max: 127 sum: 309628
    Column 6: count: 4880 hasNull: false min: 1 max: 2000 sum: 4941863

  File Statistics:
    Column 0: count: 10000 hasNull: false
    Column 1: count: 10000 hasNull: false min: 1 max: 62 sum: 288923
    Column 2: count: 10000 hasNull: false min: 19920103 max: 19980802 sum: 199481708886
    Column 3: count: 10000 hasNull: false min: 320 max: 5999748 sum: 29654861049
    Column 4: count: 10000 hasNull: false min: 1-URGENT max: 5-LOW sum: 76791
    Column 5: count: 10000 hasNull: false min: 0 max: 127 sum: 631266
    Column 6: count: 10000 hasNull: false min: 1 max: 2000 sum: 10091747

  Stripes:
    Stripe: offset: 3 data: 36047 rows: 5120 tail: 135 index: 861
    Stripe: offset: 37046 data: 34173 rows: 4880 tail: 131 index: 753

  File length: 72684 bytes
  File raw data size: 1150000 bytes
  Padding length: 0 bytes
  Padding ratio: 0%
*/
static const std::string default_orc_file = "./be/test/exec/test_data/orc_scanner/tpch_10k.orc.zstd";
static const std::string corrupted_orc_file = "./be/test/exec/test_data/orc_scanner/tpch_10k.orc.zstd.corrupted";
...
TEST_F(OrcChunkReaderTest, CorruptedZstdOrcFile) {
    std::vector<SlotDescriptor*> src_slot_descs;
    create_slot_descriptors(_runtime_state.get(), &_pool, &src_slot_descs, default_slot_descs);
    OrcChunkReader reader(_runtime_state->chunk_size(), src_slot_descs);
    auto input_stream = orc::readLocalFile(corrupted_orc_file);
    reader.init(std::move(input_stream));
    uint64_t records = 0;
    Status st;
    for (;;) {
    ...
    // Must be failed with non-OK, because of the corrupted orc file.
    ASSERT_FALSE(st.ok()) << st;
    ASSERT_TRUE(st.is_internal_error()) << st;
    // It is the second stripe corrupted, so only the first stripe can be read successfully.
    // And the first stripe contains 5120 rows.
    ASSERT_EQ(5120, records);
}
...
TEST_F(OrcChunkReaderTest, SkipStripeByConjunctsEQ) {
    ...
    // lo_orderdate == 19950430
    // stripe0 min/max = 19920103/19950429 [5120]
    // stripe1 min/max = 19950429/19980802 [4880]
    std::vector<TExprNode> nodes;
    int slot_index = 1;
    TExprNode lit_node = create_int_literal_node(TPrimitiveType::INT, 19950430);
...
TEST_F(OrcChunkReaderTest, SkipStripeByConjunctsInPred) {
    ...
    // lo_orderdate min/max = 19920103/19980802
    std::vector<TExprNode> nodes;
    int slot_index = 1;
    std::vector<int64_t> values = {0, 1, 2, 3, 4, 19920102, 19980803};
